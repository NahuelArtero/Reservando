...
Listado.prototype.buscarRestaurante = function (id) {
    var resto = this.restaurantes.find(elemento => elemento.id === id)
    if (resto != undefined) {
        return resto;
    } else {
...
//Elimina elementos repetidos en arreglos
Listado.prototype.eliminaElementosRepetidos = function (elementoAEliminar) {
    return elementoAEliminar.filter(function (elem, index, self) {
...
Listado.prototype.obtenerUbicaciones = function (elemento) {
    var c = this.restaurantes.map(elemento => {
        return elemento.ubicacion;
    });
    //Se crea un nuevo array donde se van a agregar las ciudades pero sin repetirse
    return this.eliminaElementosRepetidos(c).sort();
};
...
Listado.prototype.obtenerRubros = function () {
    var r = this.restaurantes.map(elemento => {
        return elemento.rubro;
    });
    return this.eliminaElementosRepetidos(r).sort();
}
Listado.prototype.obtenerHorarios = function () {
    var arregloH = this.restaurantes.map(elemento => {
    ...
    return this.eliminaElementosRepetidos(h).sort();
}
